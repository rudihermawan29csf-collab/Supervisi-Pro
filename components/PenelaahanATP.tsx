    ...
    <div className="space-y-6 animate-fadeIn pb-20">
      ...
      <div id="atp-export-area" className="bg-white shadow-xl border border-slate-300 p-12 max-w-5xl mx-auto text-gray-900 font-serif">
        ...
        <div className="grid grid-cols-1 gap-y-1 text-sm font-bold mb-8">
           ...
           <div className="flex items-start"><span className="w-40">Kelas / Semester</span><span className="mr-4">:</span><span className="uppercase">{selectedTeacher?.kelas || '..........'} / {settings.semester}</span></div>
           <div className="flex items-start"><span className="w-40">Hari / Tanggal</span><span className="mr-4">:</span><span className="text-blue-800 uppercase">{formatIndonesianDate(selectedTeacher?.tanggalAdm, true)}</span></div>
        </div>
